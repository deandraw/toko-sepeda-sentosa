...
export default function RegisterPage() {
    ...
    return (
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-8 shadow-xl relative">
            ...
            <div className="mb-8">
                <h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50 mb-2">Buat Akun Baru</h1>
                <p className="text-zinc-500 dark:text-zinc-400">Daftar untuk mengelola Toko Sepeda Sentosa</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full flex items-center justify-center gap-2 py-3.5 bg-zinc-900 hover:bg-blue-600 text-white rounded-xl font-bold transition-all shadow-md mt-6 group disabled:bg-zinc-500 disabled:cursor-not-allowed"
                >
                    {isLoading ? (
